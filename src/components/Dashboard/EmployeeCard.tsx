...
const EmployeeCard: React.FC = () => {
  ...
  return (
    <div className="hr-card col-span-1 row-span-2 overflow-hidden flex flex-col animate-scale-in">
      <div className="relative h-48 w-full overflow-hidden bg-gradient-to-br from-cyan-500/40 to-blue-500/40">
        <img
          src={employee.avatar}
          alt={employee.name}
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="border-t border-border/40 pt-4 mt-auto">
          ...
          <div className="flex items-center text-xs text-muted-foreground mt-4 justify-center">
