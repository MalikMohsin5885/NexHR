              ...
              {index > 0 && (
                <div
                  className={`h-0.5 w-8 sm:w-16 md:w-24 ${
                    isCompleted || isCurrent ? "bg-[#352F44]" : "bg-[#DBD8E3]"
                  }`}
                />
              )}
              <div
                className={`relative flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center rounded-full ${
                  isCompleted
                    ? "bg-[#352F44]"
                    : isCurrent
                ...
                {isCompleted ? (
                  ...
                  <span
                    className={`text-xs sm:text-sm font-medium ${
                      isCurrent ? "text-[#352F44]" : "text-[#5C5470]"
                    }`}
                  >
                    {stepIndex}
                  </span>
...
const JobPostForm: React.FC = () => {
  ...
  return (
    <div
      className={`${roboto.className} container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl rounded-md shadow-lg my-10`}
      ...
      <form onSubmit={handleSubmit}>
        ...
        {currentStep === 1 && (
          <div className="space-y-6">
            ...
            {/* Technical Skills */}
            <div>
              <label htmlFor="skills" className="block text-sm font-medium mb-1">Required Technical Skills</label>
              {isClient ? (
        ...
        {/* Step 2: Workflow & Candidate Application Form */}
        {currentStep === 2 && (
          <div className="space-y-6">
            {/* Existing Workflow & Details Section */}
            <h2 className="text-xl font-semibold border-b pb-2 mb-4 border-[#DBD8E3]">
              Workflow &amp; Details
            </h2>
            <div className="p-4 rounded-md space-y-6" style={{ backgroundColor: "#F2F1F7", border: "1px solid #DBD8E3" }}>
              <div>
              ...
              <div>
                  ...
                  {formData.screeningQuestions.map((question, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <input
                        ...
                        className="flex-grow px-3 py-2 border rounded-md shadow-sm focus:ring-1 focus:ring-[#352F44] focus:border-[#352F44] transition duration-150 ease-in-out"
                        style={{ borderColor: "#DBD8E3", backgroundColor: "#FFFFFF", color: "#2A2438" }}
                      />
                      {formData.screeningQuestions.length > 1 && (
                        <button
                          ...
                          style={{ color: "#FF6B6B", border: "none" }}
                        ...
                        >
                          ...
                          >
                            <path
                              fillRule="evenodd"
                              d="M10 18a8 8 0 100-16 8 8 0 000 16zm-3-8a.75.75 0 011.5 0h4a.75.75 0 011.5 0h-7z"
                              clipRule="evenodd"
                            />
                          </svg>
                        </button>
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md shadow-sm text-white transition duration-150 ease-in-out"
            ...
            <div className="mt-8 p-4 rounded-md" style={{ backgroundColor: "#F2F1F7", border: "1px solid #DBD8E3" }}>
              <h2 className="mb-4 text-center text-xl font-bold" style={{ color: "#2A2438" }}>
                Candidate Application Form
              </h2>
              {/* Using a grid layout similar to the rest of the form */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
                ...
                <div>
                  <label className="block text-sm font-bold mb-1">Portfolio/Website</label>
                  <input
                    type="url"
                    className="w-full px-3 py-2 border rounded-md"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
                ...
                <div>
                  <label className="block text-sm font-bold mb-1">Technical Skills</label>
                  {isClient ? (
                    <CreatableSelect<OptionType, true>
                      isMulti
                      options={skillsOptions}
                      value={candidateTechSkills}
                      onChange={setCandidateTechSkills}
                      classNamePrefix="select"
                      placeholder="Select skills or type to add new ones..."
                      styles={selectStyles}
                    />
              ...
              <div className="flex justify-end">
                <button
                  type="button"
                  className="inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md transition duration-150 ease-in-out"
                  style={{ backgroundColor: "#352F44", color: "#F2F1F7" }}
                >
                  Submit Application
                </button>
              </div>
            ...
            {/* Step 2 Buttons: "Back" and "Save and Continue" */}
